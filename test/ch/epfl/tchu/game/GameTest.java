...
public class GameTest {
    private static final class TestPlayer implements Player {
        ...
        private SortedBag<Ticket> ticketOptions;
        ...
        public void initPlayers(PlayerId ownId, Map<PlayerId, String> playerNames) {
            ...
            for (Map.Entry<PlayerId, String> m : playerNames.entrySet()) {
        ...
        public void setInitialTicketChoice(SortedBag<Ticket> tickets) {
            ...
            List<Ticket> hamma = new ArrayList();
            hamma = tickets.toList();
            for (Ticket t : hamma) {
        ...
        public SortedBag<Ticket> chooseInitialTickets() {
            SortedBag.Builder baney = new SortedBag.Builder();
            baney.add(ticketOptions.get(0));
            baney.add(ticketOptions.get(1));
            baney.add(ticketOptions.get(2));
            return baney.build();
        }
    ...
    void playLabessou() {
        ...
        Random rng = new Random((long) 7890);
        players.put(PlayerId.PLAYER_1, new TestPlayer((long) 600, new ArrayList<>(new ChMap().ALL_ROUTES)));
        players.put(PlayerId.PLAYER_2, new TestPlayer((long) 90, new ArrayList<>(new ChMap().ALL_ROUTES)));
        playerNames.put(PlayerId.PLAYER_1, "Ali Bouchleka ");
        playerNames.put(PlayerId.PLAYER_2, "Walid Abaath ");
        tickets = SortedBag.of(new ArrayList<>(new ChMap().ALL_TICKETS));
